...
* **specifications:**
  ...
  * define voltage levels, timings, data rates, usable distances, modulation method, & type of connector on each end of physical medium
...
* Layer 1 is not able to detect when collisions occur (network cards just transmitting via voltage changes on the shared medium) 
...
#### Layer 1 - Physical ####  
Layer 1 Summary (only layer 1 networking, not interacting with the other layers)  
